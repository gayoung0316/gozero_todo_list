...
class _MainHomeState extends State<MainHome> {
  ...
  String? date = DateFormat('MM월 dd일').format(DateTime.now());
    ...
    Widget toDoListBuilder() {
      return FutureBuilder(
        ...
        builder: (context, projectSnap) {
          ...
          return Visibility(
            visible: date == toDoListProvider!.toDoList[0].date,
            child: Stack(
              children: [
                SafeArea(
                  bottom: false,
                      ...
                      children: <Widget>[
                        SfCalendar(
                          ...
                          onTap: (CalendarTapDetails details) {
                            setState(() {
                              date =
                                  DateFormat('MM월 dd일').format(details.date!);
                              appointments = details.appointments;
                              view = details.targetElement;
                            });
                          },
                        ),
                        Text('$date, $appointments, $view'),
                        Row(
