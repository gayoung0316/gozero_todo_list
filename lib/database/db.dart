...
class DBHelper {
  ...
  Future<Database> get database async {
    ...
    _db = openDatabase(
      ...
      onCreate: (db, version) {
        return db.execute(
          "CREATE TABLE teseted(id INTEGER PRIMARY KEY, title TEXT, priority INTEGER, success INTEGER, color INTEGER)",
        );
      },
  ...
  Future<List<ToDo>> memos() async {
    ...
    final List<Map<String, dynamic>> maps = await db.query('teseted');
